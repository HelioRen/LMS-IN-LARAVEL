    ...
    <div class="btn-controls">
        <div class="btn-box-row row-fluid" >
            <button class="btn-box span12" style="background: #00cc00; ">
                <b style="color:#fff">WorldApps BIBLIOTECA VIRTUAL</b>
            </button>
        </div>
                ...
                <div class="module-body">
                    <form class="form-horizontal row-fluid" id="findbookform">
                        <div class="control-group">
                            <label class="control-label">Nome ou  author<br>of the book</label>
                            <div class="controls">
                                <div class="span9">
            ...
            <div class="module" style="display: none;">
                <div class="module-body">
                    <form class="form-horizontal row-fluid" id="findissueform">
                        <div class="control-group">
                            <label class="control-label">Digite o ID do livro</label>
                            <div class="controls">
            ...
            <div class="module" style="display: none;">
                <div class="module-body">
                    <form class="form-horizontal row-fluid" id="findstudentform">
                        <div class="control-group">
                            <label class="control-label">Digite o ID do estudante</label>
                            <div class="controls">
