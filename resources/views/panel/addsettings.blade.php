    ...
    <div class="module">
        ...
        <div class="row">
            <div class="module-body column">
                <h2 style="text-align:center; font-family:'Times New Roman', Times, serif">Ramos Escolares</h2>
            ...
            <div class="module-body column">
                ...
                <form class="form-horizontal row-fluid">
                    <div class="control-group">
                        <label class="control-label">Categoria do aluno</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label class="control-label">Máximo permitido</label>
                        <div class="controls">
