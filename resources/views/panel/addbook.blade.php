        ...
        <div class="module-body">
            <form class="form-horizontal row-fluid">
                <div class="control-group">
                    <label class="control-label">Ttítulo do livro</label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <label class="control-label">Número de problemas</label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <div class="controls">
                        <button type="button" class="btn btn-inverse" id="addbooks">Adicionar livros</button>
                    </div>
                </div>
            </form>
        </div>
